...
if (process.env.RESUME_VAR_JSON) CYAN_VAR = JSON.parse(process.env.RESUME_VAR_JSON).replace(/\<\|\|\>/g, " ");
else if (fs.existsSync('./var.json')) CYAN_VAR = JSON.parse(fs.readFileSync('./var.json', 'utf-8'));
